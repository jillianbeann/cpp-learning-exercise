...
//        cout << sum2 << endl;
    ...
    friend ostream& operator<<(ostream& str, const unordered_set<map < set<set<int>*>*, vector<int>* >, myUnorderedCompare, MyHash>& S) {
        str << "{ " << endl;
        for (auto i : S) { //for every map in the set
            str << "{ ";
            for (auto setSet : i) {
...
int main() {
    ...
    set<map<set<set<int>*, myCompare>*, vector<int>*, myCompare>, myCompare> S1{ //set
        {{new set<set<int>*, myCompare>{ new set<int>{16,36,56}, new set<int>{ 1, 2, 36}, new set<int>{5,46,36}}, new vector<int>{1, 2, 3} }}, //map 1
        {{new set<set<int>*, myCompare>{ new set<int>{4,2,5}, new set<int>{ 1, 4, 3}, new set<int>{5,12,31}}, new vector<int>{1, 20, 13} }}, //map 2
        {{new set<set<int>*, myCompare>{ new set<int>{4,2,5}, new set<int>{ 1, 41, 3}, new set<int>{5,12,34}}, new vector<int>{1, 20, 13} }} //map 3
    ...
    cout << "Buckets: " << H1.bucket_count() << endl;
    cout << "Hi" ;
