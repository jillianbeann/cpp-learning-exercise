...
//    if (!p) return {nullptr, nullptr};
//
//    pair<node*, node*> pairLeft = PostorderSort(p->Lchild);
//    pair<node*, node*> pairRight = PostorderSort(p->Rchild);
//
//    if (pairLeft.second && pairLeft.second->value < p->value) {
//        int save = p->value;
//        p->value = pairLeft.second->value;
//        pairLeft.second->value = save;
//        pairLeft = PostorderSort(root); // sort the left subtree again
//    }
//
...
//        pairRight = PostorderSort(root); // sort the right subtree again
//    }
//    if ((pairLeft.second &&pairRight.first) && pairRight.first->value < pairLeft.second->value) {
//        int save = pairLeft.second->value;
//        pairLeft.second->value = pairRight.first->value;
//        pairRight.first->value = save;
//        pairRight = PostorderSort(root); // sort the right subtree again
//    }
//
...
//        p->value = pairLeft.second->value;
//        pairLeft.second->value = save;
//        PostorderSort(p->Rchild); // sort the entire tree again
//    }
//    if (pairRight.first && pairRight.first->value < p->value) {
//        int save = p->value;
//        p->value = pairRight.first->value;
//        pairRight.first->value = save;
//        PostorderSort(p->Lchild); // sort the entire tree again
//    }
//    if ((pairLeft.first && pairLeft.second) && pairLeft.first->value > pairLeft.second->value) {
//        int save = pairLeft.second->value;
//        pairLeft.second->value = pairLeft.first->value;
//        pairLeft.first->value = save;
//        PostorderSort(p); // sort the entire tree again
//    }
//    if ((pairRight.first && pairRight.second) && pairRight.first->value > pairRight.second->value) {
//        int save = pairRight.first->value;
//        pairRight.first->value = pairRight.second->value;
//        pairRight.second->value = save;
//        PostorderSort(p); // sort the entire tree again
//    }
//
//    node* passLeft = p;
